...
import { CustomField } from "./CustomFieldProps";
...
import { updateCredits } from "@/lib/cloudinaryActions/user.action";
import { getCldImageUrl } from "next-cloudinary";
import {
  addImage,
  updateImage,
} from "@/lib/cloudinaryActions/image.actions";
    ...
    if (data || image) {
      ...
      if (action === "Update") {
        try {
          ...
          if (updatedImage) {
            router.push(
              `/transformations/${updatedImage._id}`
            );
          }
        } catch (error) {
          console.log(error);
